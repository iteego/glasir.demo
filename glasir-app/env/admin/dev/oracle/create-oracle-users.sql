...
drop user glasir_cat_a cascade;
create user glasir_cat_a identified by password;
grant all privileges to glasir_cat_a;

-- To avoid XAException.XAER_RMERR
grant select on sys.dba_pending_transactions to glasir_cat_a;
grant select on sys.pending_trans$ to glasir_cat_a;
grant select on sys.dba_2pc_pending to glasir_cat_a;
grant execute on sys.dbms_system to glasir_cat_a;

drop user glasir_cat_b cascade;
create user glasir_cat_b identified by password;
grant all privileges to glasir_cat_b;

-- To avoid XAException.XAER_RMERR
grant select on sys.dba_pending_transactions to glasir_cat_b;
grant select on sys.pending_trans$ to glasir_cat_b;
grant select on sys.dba_2pc_pending to glasir_cat_b;
grant execute on sys.dbms_system to glasir_cat_b;
